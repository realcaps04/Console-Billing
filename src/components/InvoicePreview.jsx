...
import { fmt, fmtDateShort, computeTotalsWithDiscount, amountInWords, buildUpiPaymentUri } from '../utils'
...
const InvoicePreview = forwardRef(function InvoicePreview({ state, onDownload, downloading }, ref) {
  ...
  useEffect(() => {
    ...
    const uri = buildUpiPaymentUri({
      ...
      amount: balanceDue,
      note: `Invoice ${state.invoiceNumber || 'INV-A01'}`,
      txnRef: state.invoiceNumber || 'INV-A01',
    })
  ...
  }, [upiId, upiPayeeName, balanceDue, state.invoiceNumber])
                ...
                <tr>
                  ...
                  <td className="inv3-meta">
                    <table className="inv3-meta-table">
                      <tbody>
                        <tr><td>Invoice #</td><td>{state.invoiceNumber || 'INV-A01'}</td></tr>
